...
//       <div className="mx-auto px-6 items-center">
//         <motion.div
...
//           <h1 className="text-5xl lg:text-7xl font-bold text-gray-900 leading-[1.1] mb-2">
...
export function Hero() {
  return (
     <div className="mx-auto px-6 items-center mt-6">
         <motion.div
          initial={{ opacity: 0, x: -50 }}
          animate={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.8, ease: 'easeOut' }}
